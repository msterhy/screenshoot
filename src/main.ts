...
const cardData = {
  title: "水质检测仪2",
  items: [
    { label: "水溶氧:", value: "9.7 mg/L", critical: true },
    { label: "水温度:", value: "29.1 °C" },
    { label: "水PH:", value: "7.9" }
  ]
};

function drawWaterQualityCard(ctx: CanvasRenderingContext2D, data: any) {
  const cardWidth = 192;
...
// drawWaterQualityCard(ctx, cardData)
